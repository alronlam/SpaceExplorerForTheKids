...
namespace ReachForTheStars
{
    ...
    /// </summary>
    public class ScreenNeptune : ScreenPlanet
    {
        public ScreenNeptune(Game1 game, Background background, List<Button> listButtons) 
            ...
            if (touchCollection.Count() > 0)
            {
                ...
                if (touch.State == TouchLocationState.Pressed)
                {
                    ...
                    else if (command.Equals("nasa"))
                    {
                        ...
                        AnimationFixed background = new AnimationFixed(game.textureNeptuneNASAInfo, 1, 0, 800, 480, 0, 0, 0);
                        NextScreen = new ScreenInfo(game, new Background(background, null), null, this);
                    }
                }
            }
